...
async def migrate_sessions(session_config: SessionLoggingConfig) -> int:
    """Helper for migrating session data from singular JSON files to the format introduced in Dotsy 2.0 with per-session folders with split metadata and message files."""
