...
from dotsy.core.paths.config_paths import resolve_local_skills_dir
from dotsy.core.paths.global_paths import GLOBAL_SKILLS_DIR
from dotsy.core.skills.models import SkillInfo, SkillMetadata
