...
def test_crush_cli_integration() -> bool:  # noqa: PLR0915
    ...
    if "qwen" in providers:
        print("   [OK] Qwen provider is available!")
    ...
    from dotsy.core.tools.builtins.crush import CRUSH_TOOLS, CrushCLI
    ...
    if crush_available:
        ...
        print("   [INFO] Crush CLI not installed (optional)")
    ...
    try:
        ...
        print("   [OK] ToolManager integration check skipped (requires config)")
...
def test_crush_tools_directly() -> None:
