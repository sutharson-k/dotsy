...
- `/skills` slash command to list all available skills
- Claude-inspired skills: code-review, architect, debugger, teacher, security
- Gemma 3n E4B model support (Google and OpenRouter providers)

### Changed

- Updated README with skills documentation and Gemma model options
